...
(let ((colors '((fg1          "#f8f8f2") ; white ; Assigment form: VARIABLE COLOR [TTY-COLOR]
                (fg2          "#e2e2dc")
                (fg3          "#ccccc7")
                (fg4          "#b6b6b2")
                (bg1          "#282a36" "#000000") ; black
                (bg2          "#373844")
                (bg3          "#464752")
                (bg4          "#565761")
      ...
      (faces '(;; default
               ...
               (dired-directory :foreground ,comment :weight normal) ; modified
               ...
               (dired-symlink :foreground ,const :weight normal :slant italic) ; modified
               ...
               ;; eshell
               (eshell-ls-directory :foreground ,comment :weight bold)
               (eshell-ls-symlink :foreground ,const :weight bold)
               (eshell-ls-executable :foreground ,func :weight bold)
               (eshell-ls-readonly :foreground ,keyword)
               (eshell-ls-special :foreground ,keyword :weight bold)
               (eshell-ls-missing :foreground ,rainbow-9 :weight bold)
               (eshell-ls-archive :foreground ,type :weight bold)
               (eshell-ls-backup :foreground ,builtin)
               (eshell-ls-product :foreground ,builtin)
               (eshell-ls-clutter :foreground ,builtin :weight bold)
               (eshell-prompt :foreground ,keyword :weight bold)
               ;; tuareg
               (tuareg-font-lock-governing-face :foreground ,str :bold t)
               (tuareg-font-lock-multistage-face :foreground ,comment :background ,bg5 :bold t)
               (tuareg-font-lock-line-number-face :foreground ,bg5)
               (tuareg-font-lock-operator-face :foreground ,str)
               (tuareg-font-lock-module-face :inherit ,font-lock-type-face)
               (tuareg-font-lock-constructor-face :foreground ,const)
               (tuareg-font-lock-error-face :foreground ,str :background ,rainbow-9 :bold t)
               (tuareg-font-lock-interactive-output-face :foreground ,bg5)
               (tuareg-font-lock-interactive-error-face :inherit ,font-lock-warning-face)
               ;; coq
               (coq-solve-tactics-face :foreground ,rainbow-9)
               (coq-cheat-face :background ,rainbow-9)
               (proof-declaration-name-face :foreground ,builtin :bold t)
               (proof-tacticals-name-face :foreground ,type)
               (proof-tactics-name-face :foreground ,type))))
